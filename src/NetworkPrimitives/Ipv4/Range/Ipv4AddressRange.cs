...
namespace NetworkPrimitives.Ipv4
{
            ...
            ISlice<Ipv4AddressRange, Ipv4Address>
    {
        ...
        internal bool AllIpsSameFirstThreeOctets => new Ipv4Subnet(StartAddress, Ipv4Cidr.Parse(24)).Contains(LastAddressInclusive);
        ...
        public bool IsSubnet(out Ipv4Subnet subnet)
        {
            ...
            subnet = new Ipv4Subnet(this.StartAddress, subnetMask);
            return true;
        }
